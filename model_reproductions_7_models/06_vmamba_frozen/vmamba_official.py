...
try:
    ...
    # CPU-only compatibility shim: the decorated Triton kernels are parsed at
    # import time even though the official code selects the PyTorch path on
    # CPU. These placeholders make that import possible; they never execute.
